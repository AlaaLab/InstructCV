...
if __name__ == "__main__":
    dataset_dir = os.getenv("DETECTRON2_DATASETS", "data")
    ...
    for name, dirname in [("train", "training"), ("val", "validation")]:
        ...
        # json config
        instance_config_file = "data/ADEChallengeData2016/ade20k_instance_imgCatIds.json"
        ...
        mapping_file = "data/ADEChallengeData2016/ade20k_instance_catid_mapping.txt"
