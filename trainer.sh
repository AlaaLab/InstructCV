...
python universal_mae.py --batch_size 64 --epochs 50 --model large --lr 0.000015 --finetune True --dataset_name oxford-pets --task_list 'segmentation' 'detection' --multi_task True
