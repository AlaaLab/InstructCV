...
python universal_mae.py --batch_size 128 --epochs 50 --model large --lr 0.000015 --finetune True --dataset_name oxford-pets --task_list 'classification' 'segmentation' 'detection' --multi_task True
